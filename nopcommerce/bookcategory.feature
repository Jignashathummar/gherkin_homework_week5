Feature:Bookcategory
  ...
  Scenario Outline: I should be able to book page with filters
    When I select book vategory from top menu page on home page
    Then I should be navigated to book category
    And I should be able see "<filters>"
  ...
  Scenario Outline:I should be able to see list of terms of each other
  ...
  Scenario Outline: I should be able to choose any filter option with specific result
    ...
    Examples:
      ...
      | sory by | price:low to hign | sorted product with the price in descending order                 |
      | sort by | price:hign to low | sorted product with the price in ascending order                  |
